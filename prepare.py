...
SOURCE_REPO = "lerobot/diffusion_pusht"
SOURCE_REVISION = "84a7c23178445c6bbf7e1a884ff497017910f653"
SOURCE_SHA = "995d14d35db57d95c35ad9704c3d79c8612b7bc45f3877e5c46c2cdc516856a8"
MODEL_SHA = "42bddc7d0fe1ef928d708c207a2c9bb8ab7166c2d2b28d3c6abb955e18fb7594"
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=Path("diffusion-pusht"))
    parser.add_argument("--download-dir", type=Path, default=Path(".diffusion-pusht-source"),
    ...
    if source is None:
        ...
        print("Downloading the original public weights (approximately 1.05 GB).", flush=True)
    ...
    if len(core) != 213 or len(state) - len(core) != 8:
